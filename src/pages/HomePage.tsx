    ...
    <div className="stack">
      ...
      <section className="stack">
        ...
        {routines.map((routine) => (
          <Link key={routine.id} to={`/routines/${routine.id}`} className="card row">
            <div style={{ flex: 1 }}>
      ...
      <div className="fab-bar">
        <button type="button" className="btn btn-primary" onClick={() => void startFree()}>
          자유운동
        </button>
        <Link className="btn btn-ghost" to="/routines/new">
          추가
        </Link>
      </div>
